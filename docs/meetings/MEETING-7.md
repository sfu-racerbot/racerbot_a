# Meeting 7: 2026-06-30, 1:30-3:30 p.m.
...
- Arianna Suen: Finished Lecture 5, Lab 1. (Behind)
    - Active Software Chat [x]
    - Active Contributions [x]
- Aston Kwan-Lai: Finished Lecture 5, Lab 1. (Behind)
    - Active Software Chat [x]
    - Active Contributions [x]
- Athanasius Liu: Finished Lecture 5, Lab 4.
    - Active Software Chat [x]
    - Active Contributions [x]
...
- Nathan Jacobson: Finished Lecture 5, Lab 4.
    - Active Software Chat [x]
    - Active Contributions [x]
- Rafael Feng: Finished Lecture 2, Lab 2. (New Member)
    - Active Software Chat []
    - Active Contributions [x]
